                        ...
                        <div
                            ...
                            <div class="pb-4 md:pb-8 w-full md:w-40">
                                <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                                     src="{{asset('/img/products/' . $item->product->image)}}" alt="dress"/>
                            </div>
                            <div
                                ...
                                <div class="w-full flex flex-col justify-start items-start space-y-8">
                                    ...
                                    <div class="flex justify-start items-start flex-col space-y-2">
                                        <p class="text-sm dark:text-white leading-none text-gray-800"><span
                                                class="dark:text-gray-400 text-gray-300">Category: </span> {{$item->product->category->name}}
                                        </p>
                                        <p class="text-sm dark:text-white leading-none text-gray-800"><span
                                                class="dark:text-gray-400 text-gray-300">Color: </span> {{$item->color->name}}
                                        </p>
                                    </div>
                                </div>
                                <div class="flex justify-between space-x-8 items-start w-full">
                                    <p class="text-base dark:text-white xl:text-lg leading-6">
                                        ${{$item->product->price / 100}}</p>
                ...
                <div
                    ...
                    <div class="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                        <div
                            ...
                            {{--                            </div>--}}
                            <div
                                class="mt-7 flex justify-center md:justify-start items-center md:items-start flex-col space-y-4">
