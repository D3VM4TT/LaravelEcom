        ...
        <div class="flex shadow-md my-10">
            <div class="w-3/4 bg-white px-10 py-10">
                <div class="flex justify-between border-b pb-8">
                    ...
                    <h2 class="font-semibold text-2xl">{{$cart->getProductCount()}} Items</h2>
                </div>
                    ...
                    <div class="flex items-center cursor-pointer hover:bg-gray-100 -mx-8 px-6 py-5">
                        <div class="flex w-2/5"> <!-- product -->
                            ...
                            <div class="flex flex-col justify-between ml-4 flex-grow">
                                ...
                                {!! Form::open(['method' => 'DELETE', 'route' => ['cart.remove', $item], 'style' => 'display:inline']) !!}
                                {!! Form::submit('Delete', ['class' => 'font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer']) !!}
                                {!! Form::close() !!}
                        ...
                        {{-- TODO: Add a ItemService or something that calculates the price of the item --}}
