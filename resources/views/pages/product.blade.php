    ...
    <section class="text-gray-700 body-font overflow-hidden bg-white">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200 max-h-96"
                    ...
                    <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                        <div class="flex">
                            ...
                            @foreach($product->colors as $color)
                                <button style="background-color: {{$color->code}}" class="border-2 border-gray-300 ml-1 rounded-full w-6 h-6 focus:outline-none"></button>
                            @endforeach
